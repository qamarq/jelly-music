...
import com.qamarq.jellymusic.data.playback.EXTRA_OPEN_PLAYER_FROM_NOTIFICATION
...
import com.qamarq.jellymusic.ui.screens.ElovaireRoot
import com.qamarq.jellymusic.ui.theme.JellyMusicTheme
import com.qamarq.jellymusic.ui.theme.themeBackgroundForMode
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val app = application as JellyMusicApp
    ...
    private fun handleNotificationIntent() {
        if (intent?.getBooleanExtra(EXTRA_OPEN_PLAYER_FROM_NOTIFICATION, false) == true) {
            (application as JellyMusicApp).container.requestOpenPlayer()
